...
describe("getQuestionShareText", () => {
    ...
    describe("measure", () => {
        it("calculates distance and formats for rail-measure", async () => {
            ...
            expect(result).toBe(
                "We are 1.235km from a Train Station. Are you closer or further to your nearest Train Station?",
            );
        });
        ...
        it("calculates distance and formats for generic place", async () => {
            ...
            expect(result).toBe(
                "We are 0.5km from a Park. Are you closer or further to your nearest Park?",
            );
        });
        ...
        it("uses fallback text when distance calculation fails", async () => {
            ...
            expect(result).toBe(
                "We are [distance] from a Hospital. Are you closer or further to your nearest Hospital?",
            );
        });
    });
