...
export const adjustPerTentacle = async (question: any, mapData: any) => {
...
export const hiderifyTentacles = async (question: any) => {
...
export const tentaclesPlanningPolygon = async (question: any) => {
    const rawPoints = await findTentacleLocations(question);
    const points = rawPoints;
