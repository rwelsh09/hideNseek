export const PLACES = [
    ...
    { id: "church", label: "Church", labelPlural: "Churches", icon: "Church", tag: "amenity", type: "generic" },
    { id: "supermarket", label: "Supermarket", labelPlural: "Supermarkets", icon: "ShoppingCart", tag: "shop", type: "generic" },
] as const;
