    ...
    const loadHidingZone = (hidingZone: string) => {
        try {
            ...
            if (geojson.isGameSettings === true) {
                ...
                if (
                    ...
                    if (typeof geojson.disabledStations === "string") {
                        disabledStations.set(
                            decodeDisabledStations(geojson.disabledStations),
                        );
                ...
                if (
                    geojson.hidingRadius !== null &&
                    geojson.hidingRadius !== undefined
                ) {
                                    ...
                                    <AlertDialogContent>
                                        <AlertDialogHeader>
                                            ...
                                            <AlertDialogDescription>
                                                ...
                                                everything? This will delete all
                                                saved data and settings. This
