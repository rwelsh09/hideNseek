...
export const LeafletActionButtons = () => {
    ...
    const buttonClass =
        "leaflet-full-screen-specific-name bg-white hover:bg-[#f4f4f4] active:bg-slate-200 transition-colors w-[44px] h-[44px] md:w-[34px] md:h-[34px] p-0 rounded-[4px] flex items-center justify-center border-[2px] border-[rgba(0,0,0,0.2)] bg-clip-padding cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-400 focus-visible:ring-offset-2";
