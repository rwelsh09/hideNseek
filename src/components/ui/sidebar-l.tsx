    ...
    (
        ...
        return (
            ...
            >
                ...
                <div
                    className={cn(
                        "duration-200 fixed inset-y-0 z-[1040] hidden h-svh w-[--sidebar-width] transition-[left,right,width] ease-linear md:flex",
                        side === "left"
...
>(({ className, onClick, ...props }, ref) => {
    ...
    return (
        <button
            ...
            className={cn(
                "bg-background hover:bg-accent hover:text-accent-foreground text-foreground w-[34px] h-[34px] rounded-sm border border-input cursor-pointer justify-center p-0",
