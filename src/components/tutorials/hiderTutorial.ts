...
export const getHiderSteps = (hiderDriverObj: any): DriveStep[] => [
    ...
    },
    {
        ...
        popover: {
            ...
            description:
                "When a Seeker shares a question with you, their link will load the question and show the answer. If you're offline, copy it and click this button to paste it onto the map and see the answer.",
            side: "right",
            align: "end",
            showButtons: ["next", "close"],
        },
