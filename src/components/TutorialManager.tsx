                    ...
                    },
                    {
                        ...
                        popover: {
                            ...
                            onPopoverRender: () => {
                                ...
                                (
                                    hiderDriverObj as any
                                )._markerClickCheckInterval = checkInterval;
                            },
                            onDeselected: () => {
                                if (
                                    (hiderDriverObj as any)
                    ...
                    },
                    {
                        ...
                        popover: {
                            ...
                            onPopoverRender: () => {
                                ...
                                (
                                    hiderDriverObj as any
                                )._popupCloseCheckInterval = checkInterval;
                            },
                            onDeselected: () => {
                                if (
                                    (hiderDriverObj as any)
                    ...
                    },
                    {
                        ...
                        popover: {
                            ...
                            onPopoverRender: () => {
                                ...
                                (driverObj as any)._openSidebarCheckInterval =
                                    checkInterval;
                            },
                            onDeselected: () => {
                                if (
