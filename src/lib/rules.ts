...
export const QUESTION_RULES: Record<string, string> = {
    ...
    photos: "Seekers request a photograph from the Hider's current perspective. The photos must accurately represent their location without being intentionally misleading. The Hider may edit the photos to blackout words.",
};
