...
export const QUESTION_RULES: Record<string, string> = {
    "hot/cold":
        "Seekers travel a specific distance (e.g., 1km) providing the Hider with their starting and end point. The Hider must reveal if the Seekers are now Warmer (closer to) or Colder (farther from) the Hider's position.",
    radar: "Seekers select a specific distance (e.g., 5km) to project a Radar from their current location. The Hider must answer 'Inside' or 'Outside' to whether their location falls within that Radar.",
