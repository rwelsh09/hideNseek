...
`,$=new Map,ue=(e,t)=>{W(()=>{if(!e||typeof document>`u`)return;let n=document,r=$.get(n);if(r){t&&r.setAttribute(`nonce`,t);return}let i=n.createElement(`style`);i.textContent=e,t&&i.setAttribute(`nonce`,t),n.head.appendChild(i),$.set(n,i)},[t])};function de(e){return ue(le,e.nonce),r.createElement(ce,{...e})}export{Q as Bounce,oe as Flip,X as Icons,ie as Slide,de as ToastContainer,ae as Zoom,d as collapseToast,f as cssTransition,z as toast};